// 退休年龄计算模块 - ES Module版本

// 退休年龄区间表
export const RETIREMENT_AGE_TABLES = {
    // 男职工法定退休年龄（区间表）
    male_worker: {
        ranges: [
 ...
 */
export function toBirthCode(year, month) {
 ...
 */
export function parseRetirementCode(code) {
 ...
 */
export function getRetirementAge(birthYear, birthMonth, personType) {
 ...
 */
export function getStatutoryRetirementAge(birthYear, birthMonth, gender, personType) {
